...
_G.packer_plugins = {
  ["Navigator.nvim"] = {
    config = { 'require("user/plugin_config/Navigator")' },
    loaded = true,
    path = "/home/tcomi/.local/share/nvim/site/pack/packer/start/Navigator.nvim",
    url = "https://github.com/numToStr/Navigator.nvim"
  },
  ["gruvbox.nvim"] = {
    config = { 'require("user/plugin_config/gruvbox")' },
    loaded = true,
  ...
  ["nvim-colorizer.lua"] = {
    config = { 'require("user/plugin_config/nvim-colorizer")' },
    loaded = true,
    path = "/home/tcomi/.local/share/nvim/site/pack/packer/start/nvim-colorizer.lua",
    url = "https://github.com/NvChad/nvim-colorizer.lua"
  },
  ["nvim-tree.lua"] = {
    config = { 'require("user/plugin_config/nvim-tree")' },
    loaded = true,
  ...
  ["vim-commentary"] = {
    loaded = true,
    path = "/home/tcomi/.local/share/nvim/site/pack/packer/start/vim-commentary",
  ...
  ["vim-surround"] = {
    config = { 'require("user/plugin_config/vim-surround")' },
    loaded = true,
...
require("user/plugin_config/Navigator")
...
require("user/plugin_config/gruvbox")
time([[Config for gruvbox.nvim]], false)
-- Config for: vim-surround
time([[Config for vim-surround]], true)
require("user/plugin_config/vim-surround")
